// src/app/recettes/utilisateur/privees/page.tsx
"use client";
...
export default function RecettesPriveesUtilisateurPage() {
  const { user } = useAuth();
  ...
  useEffect(() => {
    if (user) {
      execute(() => getRecettes(1, 10, search, false, user.id_utilisateur));
    }
  }, [search, execute, user]);

  return (
    <div>
      <h2 className="text-xl font-semibold mb-4">Mes Recettes Privées</h2>
